...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">อุปกรณ์ตกปลา</h2>
		</div>
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								<li><a href="#">คันเบ็ด</a></li>
								<li><a href="#">รอกตกปลา</a></li>
								<li><a href="#">สายตกปลา</a></li>
								<li><a href="#">ตะขอเบ็ด</a></li>
							</ul>
						</div>
						<div class="sidebar_section">
					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_1.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$1500</div>
									<div class="product_name"><div><a href="#" tabindex="0">Ryujin Forrest</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							</div>
							...
							<div class="product_item is_new">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_2.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$1700</div>
									<div class="product_name"><div><a href="#" tabindex="0">Skyhawk</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item is_new">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_3.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$2200</div>
									<div class="product_name"><div><a href="#" tabindex="0">Quantum Fishing</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_4.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$1400</div>
									<div class="product_name"><div><a href="#" tabindex="0">Shakespeare Cirrus</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item is_new">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_5.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$2900</div>
									<div class="product_name"><div><a href="#" tabindex="0">Vara Dep Escar</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item is_new">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_6.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$950</div>
									<div class="product_name"><div><a href="#" tabindex="0">SEASHARK</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_7.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$2100</div>
									<div class="product_name"><div><a href="#" tabindex="0">Grips</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_8.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$3500></div>
									<div class="product_name"><div><a href="#" tabindex="0">DAIDO CHAOS</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_9.jpg" alt=""></div>
								<div class="product_content">
									<div class="product_price">$800</div>
									<div class="product_name"><div><a href="#" tabindex="0">LIXADA</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
							...
							<div class="product_item">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/rod_10.png" alt=""></div>
								<div class="product_content">
									<div class="product_price">$1400</div>
									<div class="product_name"><div><a href="#" tabindex="0">SCORPION A+</a></div></div><br/>
									<div>
										<a href="#" class="btn btn-primary">Add Spec</a>
									</div>
								</div>
